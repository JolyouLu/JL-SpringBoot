...
import top.jolyoulu.jlnetty.server.DefServer;
...
//        AbstractNettyServer server = new DefServer(9999, new DefServerChannel());
//        AbstractNettyServer server = new WebSocketServer(9999, new WebSocketServerChannel());
        AbstractNettyServer server = new ProtoBufServer(9999, new ProtoBufServerChannel());
        try {
            //初始化一个nettyServer
